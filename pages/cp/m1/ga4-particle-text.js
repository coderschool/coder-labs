...
export default function GA4ParticleText() {
  return (
    <Page title="">
      <Container maxWidth="lg">
        <HeaderBreadcrumbs
          heading="Generative Art Part 4 - Particle Text"
          links={[
        ...
        <Card>
          <Box sx={{ position: "relative" }}>
            <TitleStyle>Demo - Hover your mouse on the text</TitleStyle>
            <IframeStyle
              src="/demo/cp/m1/ga4-particle-text/index.html"
              title="GA3 Drawing"
            />
            <OverlayStyle />
            <Image
