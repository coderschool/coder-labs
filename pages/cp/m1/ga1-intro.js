...
export default function GA1Intro() {
  return (
    <Page title="">
      <Container maxWidth="lg">
        <HeaderBreadcrumbs
          heading="Generative Art Part 1 - Intro to HTML Canvas"
          links={[
        ...
        <Card>
          <Box sx={{ position: "relative" }}>
            <TitleStyle>Demo - Hover your mouse on the canvas</TitleStyle>
            <IframeStyle
              src="/demo/cp/m1/ga1-intro/index.html"
              title="GA2 Matrix Rain"
            />
            <OverlayStyle />
            <Image
              alt="post cover"
