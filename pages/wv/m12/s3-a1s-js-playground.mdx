...
function fToC (fDegree) { const cDegree = (fDegree - 32 * 5 / 9); return cDegree
...
console.log(calculateBMI(1.6, 55)) // expected result: "your
BMI is 21.48
...
function canDrinkBeer(age) {
    if(age > 21) {
      return "You are " + age + ", you can drink
beer in New York"
  } else {
