...
These solutions are designed for beginners to quickly follow.
There are, in fact, many more ways to solve these puzzles.
Try it out yourself!
...
Karel always follows the right side wall to find the way out.
