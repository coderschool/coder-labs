...
- **Relative**: Relative positioning moves the element box relatively to its original position in the flow.
  ...
  - This simply means, all relative position elements will have an **anchor** which place at its original static place.
...
- **Absolute**: The element is positioned base on it first non-static ancestor element.
