...
- **HTML as "STRUCTURE"**: HyperText Markup Language (HTML) defines the structure, content and semantics of web pages on the web.
- **CSS as "PRESENTATION"**: Cascading Style Sheets (CSS) sets the look and style of a web page. CSS provides style to the structure provided by HTML.
- **JavaScript as "BEHAVIOR"**: JavaScript allows us to define interaction in our pages. What happens when a user clicks on a certain area?
...
<br />
<br />
## 3️⃣ The anatomy of an HTML Element

![html element](../../assets/wv/m11/html_element.png)
...
Elements that are created with only one tag are called empty elements (also known as self-closing elements) and cannot have any child elements. Examples of this are `<img>` and `<input>`.
...
![htm structure](../../assets/wv/m11/html_structure.png)
...
![html_sematic](../../assets/wv/m11/html_semantic.png)
...
- <a href="https://developer.mozilla.org/en-US/docs/Web/HTML" target="_blank">MDN HTML Overview</a>
- <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element" target="_blank">MDN HTML Elements</a>
- <a href="https://htmlreference.io/" target="_blank">HTML Elements</a>
- <a href="http://www.simplehtmlguide.com/cheatsheet.php" target="_blank">A simple guide to HTML (cheatsheet)</a>
- <a href="https://medium.com/@sergimarquez/8-best-practices-to-write-clean-html-code-1cd407e2a7ec" target="_blank">8 best practices to write clean HTML code</a>
  <br />
  <br />
  <br />
