...
- **servers**:
  The computers that make up the internet. Because they “serve up” documents upon request, these computers are known as **servers**. The role of the server is to wait for a request for information, and then retrieve and send that information back as quickly as possible.
...
<br />
<br />
## 2️⃣ A brief history of the web

The **web**, originally called the **World Wide Web(www)**, is just one of the ways information can be shared over the internet. It allows documents to be linked to one another via **hypertext** links, thus forming a huge "web" of connected information.
...
![url part](../../assets/wv/m11/url_parts.png)
...
![intro](../../assets/wv/m11/intro_web_00.png)
