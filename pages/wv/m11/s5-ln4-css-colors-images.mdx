...
CSS4 supports a set of <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/color_value" target="_blank">140 color names</a>:

![css_color_names](../../assets/wv/m11/css_color_names.png)
...
![css_rgb_model](../../assets/wv/m11/css_rgb_model.png)
...
- <a href="http://flatuicolors.com/" target="_blank">Cool Flat UI colors</a>
- Even more <a href="http://getuicolors.com/" target="_blank">cool colors</a>
- Find <a href="http://www.0to255.com/" target="_blank">variations of colors</a>
...
![css_rgba](../../assets/wv/m11/css_rgba.png)

## Images

- Basically all free images in <a href="http://thestocks.im/" target="_blank">one place</a>
- <a href="https://unsplash.com/" target="_blank">Unsplash</a>, a must see
- <a href="http://foodiesfeed.com/" target="_blank">Food images</a>
...
For more precise control of the angle, you can use more specific units, such as degrees. The value `0deg` points straight up (equivalent to top); higher values move clockwise around the circle, so `90deg` points to the right, `180deg` points down, `360deg` points up again.
...
![css_radial_gradient](../../assets/wv/m11/css_radial_gradient.png)
...
![](../../assets/wv/m11/css_box-shadow.png)
...
![Blend mode tinting](../../assets/wv/m11/css_blend_mode_tinting.png)
...
- `multiply`: The lighter the front color, the more the base color will show through.
- `darken`: Selects the darker of the two colors.
- `color-burn`: Darkens the base color, increasing the contrast.
- `screen`: The darker the front color, the more the base color will show through.
- `lighten`: Selects the lighter of the colors.
- `color-dodge`: Lightens base color, decreasing contrast.
- `overlay`: Increases contrast by applying multiply to dark colors and screen to light colors, at half strength.
...
- `hue`: Applies hue from the top color onto the bottom color.
...
![CSS Blend Mode scratch](../../assets/wv/m11/css_blend_mode_scratch.png)
![CSS Blend Mode Texture](../../assets/wv/m11/css_blend_mode_texture.png)
...
![CSS Mix Blend](../../assets/wv/m11/css_blend_mode_mix_blend.png)

## Additional reading

- <a href="https://css-tricks.com/design-considerations-text-images/" target="_blank">Text on Images</a>
- <a href="http://uigradients.com/" target="_blank">Beautiful gradients for webdesign</a>
- <a href="https://css-tricks.com/stripes-css/" target="_blank">Stripes in CSS</a>
- <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/radial-gradient" target="_blank">MDN Radial Gradient</a>
