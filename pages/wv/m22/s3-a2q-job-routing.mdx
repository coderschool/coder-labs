...
<a
  href="https://github.com/remix-run/react-router/tree/main/examples/auth"
  target="_blank"
>
...
<a
  href="https://github.com/remix-run/react-router/tree/main/examples/modal"
  target="_blank"
>
  Modal with React Router
</a>

<a
  href="https://drive.google.com/file/d/175JD05bo6Cjn3XupqlBf83n2Jta1Ymz1/view?usp=sharing"
  target="_blank"
>
  Create your fake API with JSON-server then practice fetching data. (Job data)
</a>

<a href="https://mui.com/components/modal/" target="_blank">
  Modal Material UI
</a>
...
🚀 <a href="https://github.com/remix-run/react-router/tree/main/examples/search-params" target="_blank"> Search params with React Router </a>

_**Note**: These examples of React Router are written in Typescript. Therefore, there will be some syntax that you might not be familiar. Feel free to ask your mentor/instructor for clarity._
