...
![](assets/dom_node_tree.png)

The nodes within the first `&lt;p&gt;` element:

![](assets/dom_node_tree_2.png)
...
To get the value of an attribute attached to an element node, we call **getAttribute()`** with a single argument: the attribute nae.
