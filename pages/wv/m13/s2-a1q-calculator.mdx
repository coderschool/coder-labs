...
You can work on an online editor like [CodeSandbox](https://codesandbox.io/) or work locally with Visual Studio Code, then push it to Github. Then submit the project link to CoderSchool.
